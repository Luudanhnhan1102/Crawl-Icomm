#pragma checksum "/Users/admin/Downloads/Icomm.NewsCrawl.Website/Views/Home/Config.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5bc680e3deef085b4cc28dd08269a506afc36f32"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5bc680e3deef085b4cc28dd08269a506afc36f32", @"/Views/Home/Config.cshtml")]
    public class Views_Home_Config : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 2 "/Users/admin/Downloads/Icomm.NewsCrawl.Website/Views/Home/Config.cshtml"
  
    ViewBag.Title = "Config";

#line default
#line hidden
            BeginContext(40, 1758, true);
...
");
            ...
            WriteLiteral(@"
                    ...
                    <div class=""form-group"">
");
            WriteLiteral(@"                        <label for=""RegexDate"" class=""control-label col-md-2"">RegexDate</label>
                        <div class=""col-md-10"">
                    ...
                    <div class=""form-group"">
                        ...
                        <div class=""col-md-10"">
                            <input style=""min-width: 100%"" class=""form-control"" id=""XpathSnippet");
            WriteLiteral(@""" name=""XpathSnippet"" type=""text"">
                        </div>
                    </div>
                </form>
            </div>
        ...
        $.getJSON(uri)
            .done(function (data) {
                ...
                $.each(data, function (i, data) {
                   ");
            WriteLiteral(@" content += ""<tr><td id='Id'>"";
                    content += data.Id || """";
                    ...
                    content += ""</td><td s");
            WriteLiteral(@"tyle='display:none;' id='RegexTime'>"";
            ...
            WriteLiteral(@" ""</td><td id='XpathSnippet'>"" + data.XpathSnippet + ""</td></tr>"";
                });
                content += ""</tbody>"";
                $('#config').html(content);
            ...
            WriteLiteral(@"utton type=\""button\"" id=\""delete\"" class=\""btn btn-danger pull-left\"">Delete</button>"");
                    $(""#myModal"").modal();
            ...
            WriteLiteral(@"on () {
                ...
                $(""#create"").click(function () {
                    $(""#form :input"").each(function () {
                        //console.log($(""form#form"").find($(this).attr(""id""");
            WriteLiteral(@")).val());
                        $(this).val("""");
                    });
                    $("".modal-footer"").children().remove(""#createtmp"");
